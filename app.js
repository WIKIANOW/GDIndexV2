...
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/WIKIANOW/GDIndexV2@437eb16/css/mdui_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/WIKIANOW/GDIndexV2/css/mdui_v2.min.css">'
  );
}
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/WIKIANOW/GDIndexV2/css/nexmoe_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/WIKIANOW/GDIndexV2/css/nexmoe_v2.min.css">'
  );
}
document.write(
  '<script src="//cdn.jsdelivr.net/gh/WIKIANOW/GDIndexV2/js/mdui.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/WIKIANOW/GDIndexV2/js/flv.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/WIKIANOW/GDIndexV2/js/DPlayer.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/npm/marked@4.0.0/marked.min.js"></script>'
);
document.write(
  "<style>.mdui-appbar .mdui-toolbar{height:56px;font-size:1pc}.mdui-toolbar>i{opacity:.5}.mdui-toolbar>i{padding:0}.mdui-toolbar>a:hover,a.active,a.mdui-typo-headline{opacity:1}.mdui-container{/* max-width:980px */;margin:auto}.mdui-list-item{transition:none}.mdui-list>.th{background-color:initial}.mdui-list-item>a{width:100%;line-height:3pc}.mdui-list-item{margin:2px 0;padding:0}.mdui-toolbar>a:last-child{opacity:1; color: #000}@media screen and (max-width:980px){.mdui-list-item .mdui-text-right{display:none}.mdui-container{width:100%!important;margin:0}}</style>"
);
if (UI.dark_mode) {
  document.write(
...
<script src="//cdn.jsdelivr.net/gh/WIKIANOW/GDIndexV2/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/WIKIANOW/GDIndexV2/js/ext-language_tools.js"></script>
	`;
  $("#content").html(content);
